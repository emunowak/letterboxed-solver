...
public class NonNullWordsValidator extends AbstractValidator<LetterWall, SolverInvalidConfigurationException> {
    ...
    protected LetterWall validateAndApplyNext( LetterWall letterWall ) throws SolverInvalidConfigurationException {
        if( CollectionUtils.isEmpty( letterWall.getWords() ) ) {
